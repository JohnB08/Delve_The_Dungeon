...
For actions this is the general rule:

general movement that is not evading or running is tied to 1
attacking and aggressive physical actions are tied to 2
talking and other speech or mind related actions are tied to 3
evasive actions like dodging, rolling running and so on is tied to 4
examining or looking at something is tied to 5
Help is tied to 6
*/
public class PlayerActions
{
    ...
    public void ParseAction(string input)
    {
        ...
        string[] subStrings = input.Split(' ', StringSplitOptions.RemoveEmptyEntries);

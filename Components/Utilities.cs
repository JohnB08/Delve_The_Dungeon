...
{
    public Dictionary<string, int> Actions = new Dictionary<string, int> { { "move", 1 }, { "go", 1 }, { "run", 1 }, { "walk", 1 }, { "attack", 2 }, { "fight", 2 }, { "hit", 2 }, { "look", 5 }, { "examine", 5 }, { "spy", 5 }, { "scry", 5 }, { "talk", 3 }, { "yell", 3 }, { "whisper", 3 }, { "fool", 3 }, { "ruse", 3 }, { "dodge", 4 }, { "roll", 4 }, { "evade", 4 }, { "trick", 3 }, { "help", 6 }, { "h", 6 }, { "hjelp", 6 } };
    ...
    public Dictionary<string, int> Affirmative = new Dictionary<string, int> { { "yes", 1 }, { "y", 1 }, { "aye", 1 }, { "ye", 1 }, { "ja", 1 }, { "no", 2 }, { "n", 2 }, { "nay", 2 }, { "nei", 2 }, { "sure", 1 } };
